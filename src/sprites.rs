...
pub static BYTES_TRACKTILE_BLANK: &[u8; 1891] = include_bytes!("../assets/sprites/Tracktile_blank.png");
...
pub static BYTES_TRACKTILE_JB_FLIPPED: &[u8; 8323] = include_bytes!("../assets/sprites/Tracktile_jb_flipped.png");
pub static BYTES_TRACKTILE_JS: &[u8; 6515] = include_bytes!("../assets/sprites/Tracktile_js.png");
pub static BYTES_TRACKTILE_JS_FLIPPED: &[u8; 6795] = include_bytes!("../assets/sprites/Tracktile_js_flipped.png");
pub static BYTES_TRACKTILE_M: &[u8; 9902] = include_bytes!("../assets/sprites/Tracktile_m.png");
pub static BYTES_TRACKTILE_M_FLIPPED: &[u8; 10282] = include_bytes!("../assets/sprites/Tracktile_m_flipped.png");
